...
TmetricModP = glm(BoatProportionPresence ~ richness_comb + total_cover, data = ecometrics, family = binomial(), weights = nFiles)
TmetricModL = glm(BoatProportionPresence ~ oyster_perimeter + saltmarsh_area, data = ecometrics, family = binomial(), weights = nFiles)
TmetricModPL = glm(BoatProportionPresence ~ richness_comb + total_cover + oyster_perimeter + saltmarsh_area, data = ecometrics, family = binomial(), weights = nFiles)
