...
### Modeling toadfish - included in original manuscript, needs to be corrected
...
```{r}
TmetricModP = lm(PercentPresence ~ richness_comb + total_cover, data = ecometrics)
TmetricModL = lm(PercentPresence ~ oyster_perimeter + saltmarsh_area, data = ecometrics)
#TmetricModC = lm(PercentPresence ~ herbivore, data = ecometrics)
#TmetricModA = lm(PercentPresence ~ deploy_num, data = ecometrics)
TmetricModPL = lm(PercentPresence ~ richness_comb + total_cover + oyster_perimeter + saltmarsh_area, data = ecometrics)
...
### Modeling toadfish using binomial glm - did not fully apply code, getting a warning

runs with quasi binomial family, but doesn't give R squared
To use a binomial model would need to add weights for each site (total number of days)

```{r}
#
ecometrics$ProportionPresence = ecometrics$PercentPresence/100

TmetricModP = glm(ProportionPresence ~ richness_comb + total_cover, data = ecometrics, family = quasibinomial())
TmetricModL = glm(ProportionPresence ~ oyster_perimeter + saltmarsh_area, data = ecometrics, family = quasibinomial())
TmetricModC = glm(ProportionPresence ~ herbivore, data = ecometrics, family = quasibinomial())
TmetricModA = glm(ProportionPresence ~ deploy_num, data = ecometrics, family = quasibinomial())
TmetricModPL = glm(ProportionPresence ~ richness_comb + total_cover + oyster_perimeter + saltmarsh_area, data = ecometrics, family = quasibinomial())
TmetricModPC = glm(ProportionPresence ~ richness_comb + total_cover + herbivore, data = ecometrics, family = quasibinomial())
TmetricModPA = glm(ProportionPresence ~ richness_comb + total_cover + deploy_num, data = ecometrics, family = quasibinomial())
TmetricModLC = glm(ProportionPresence ~ oyster_perimeter + saltmarsh_area + herbivore, data = ecometrics, family = quasibinomial())
TmetricModLA = glm(ProportionPresence ~ oyster_perimeter + saltmarsh_area + deploy_num, data = ecometrics, family = quasibinomial())
TmetricModCA = glm(ProportionPresence ~ herbivore + deploy_num, data = ecometrics, family = quasibinomial())
TmetricModPLC = glm(ProportionPresence ~ richness_comb + total_cover + oyster_perimeter + saltmarsh_area + herbivore, data = ecometrics, family = quasibinomial())
TmetricModPLA = glm(ProportionPresence ~ richness_comb + total_cover + oyster_perimeter + saltmarsh_area + deploy_num, data = ecometrics, family = quasibinomial())
TmetricModPCA = glm(ProportionPresence ~ richness_comb + total_cover + herbivore + deploy_num, data = ecometrics, family = quasibinomial())
TmetricModLCA = glm(ProportionPresence ~ oyster_perimeter + saltmarsh_area + herbivore + deploy_num, data = ecometrics, family = quasibinomial())
TmetricModPLCA = glm(ProportionPresence ~ richness_comb + total_cover + oyster_perimeter + saltmarsh_area + herbivore + deploy_num, data = ecometrics, family = quasibinomial())
